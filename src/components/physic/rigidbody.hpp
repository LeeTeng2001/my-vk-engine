...
class RigidBodyComponent : public Component {
    ...
    private:
        ...
        [[nodiscard]] JPH::EMotionType getMotionType() const {
            return _isStatic ? JPH::EMotionType::Static : JPH::EMotionType::Dynamic;
        }
        [[nodiscard]] JPH::ObjectLayer getMotionLayer() const {
            return _isStatic ? PhyObjLayers::NON_MOVING : PhyObjLayers::MOVING;
        }
        [[nodiscard]] JPH::EActivation getInitialActivation() const {
            return _isStatic ? JPH::EActivation::DontActivate : JPH::EActivation::Activate;
        }
