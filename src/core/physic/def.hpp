    ...
    public:
        ...
        [[nodiscard]] const char *GetBroadPhaseLayerName(
            ...
            switch ((JPH::BroadPhaseLayer::Type)inLayer) {
                case (JPH::BroadPhaseLayer::Type)PhyBroadPhaseLayers::NON_MOVING:
                    return "NON_MOVING";
                case (JPH::BroadPhaseLayer::Type)PhyBroadPhaseLayers::MOVING:
                    return "MOVING";
                default:
                    JPH_ASSERT(false);
                    return "INVALID";
    ...
    public:
        [[nodiscard]] bool ShouldCollide(JPH::ObjectLayer inObject1,
            ...
            switch (inObject1) {
                case PhyObjLayers::NON_MOVING:
                    return inObject2 ==
                           PhyObjLayers::MOVING;  // Non moving only collides with moving
                case PhyObjLayers::MOVING:
